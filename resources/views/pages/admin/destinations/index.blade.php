...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('destinations.create') }}" class="d-none d-sm-inline-block btn bgColor bgHover text-white px-4 shadow-sm"><i class="fas fa-plus"></i> Create</a>
    </div>
        ...
        <table class="table table-bordered rounded-3 bg-white my-0 mx-auto">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle" width="20%">{{ $destination->city }}, {{ $destination->area }}, {{ $destination->country }}</td>
                    <td class="align-middle"">
                        <a href="{{ route('destinations.edit', $destination->id) }}" class="btn bgColor bgHover text-white"><i class="fas fa-pen"></i></a>
